...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2024 at 10:51 AM
...
(5, 'budi@example.com', 'password456', 'Budi', '085678901234');
...
(9, 4, 9, '2024-05-10', 85000, 'Tiki REG (2 Hari Kerja)', 8000, 'Jakarta', 'Lunas (Barang Terkirim)', '12345678'),
(10, 5, 10, '2024-05-11', 140000, 'Pos Indonesia (3-5 Hari Kerja)', 12000, 'Bandung', 'Proses', '');
...
(1, 'The Great Gatsby', 55000, 180, 'tb1.png', 'Novel klasik karya F. Scott Fitzgerald yang menggambarkan kehidupan mewah dan penuh intrik di era Roaring Twenties di Amerika Serikat.', 'tb1alt.png', 7),
(2, 'Sapiens', 75000, 220, 'tb2.png', 'Buku non-fiksi karya Yuval Noah Harari yang merangkum sejarah manusia dari zaman purba hingga masa modern, membahas evolusi, peradaban, dan revolusi kognitif.', 'tb2alt.png', 8),
(3, 'Pride and Prejudice', 48000, 170, 'tb3.png', 'Novel klasik karya Jane Austen yang mengisahkan kisah percintaan antara Elizabeth Bennet dan Mr. Darcy di tengah-tengah norma-norma sosial pada era Regency di Inggris.', 'tb3alt.png', 6),
(4, 'Project Hail Mary', 85000, 280, 'tb4.png', 'Novel fiksi ilmiah karya Andy Weir tentang seorang astronot yang terbangun dari hibernasi di tengah perjalanan ruang angkasa dan harus menyelamatkan umat manusia dari kepunahan.', 'tb4alt.png', 4),
